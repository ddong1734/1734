...
const SkillsData = {
    ...
    'DAIDO_S2': {
        ...
        duration: 2000, speedMult: 2.6,
        tickInterval: 200, tickDamage: 20, hitRadius: 190,
        pullRadius: 120,                 // 시전자 주변 이 거리로 끌어당긴다
        finishRadius: 330, finishDamage: 50, finishStun: 1000,
        effect: 'daido_rush'
    },
