...
// ============================================================================
// ⚡ 카시모 하지메 — 스킬 버튼 상태 표시
//    ✅ [수정] 3번 [환수호박] 이 구현되었으므로 더 이상 비활성 처리하지 않는다.
//    ⚡🌋 주력 방출 중에는 2번 버튼이 보랏빛으로 빛난다.
//    ⚡🔮 환수호박 중에는 3번 버튼이 숨겨지고 1·2번이 각성 스킬로 바뀐다.
//         (라벨 · 색상 전환은 gameState.js 의 refreshKashimoSkillLabel 이 담당)
// ============================================================================
...
window.updateKashimoSkillDim = () => {
    ...
    //    (환수호박 각성 중에는 2번이 '음파'이므로 이 연출을 쓰지 않는다)
    if (!amber) {
