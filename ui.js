...
// ============================================================================
// 📜 [신규] 퀘스트 배너 (전장 인원 바로 밑)
// ============================================================================
window.setQuestText = (text) => {
    const el = document.getElementById('questBanner');
    if (!el) return;
    if (!text) { el.style.display = 'none'; el.innerText = ''; window.currentQuestText = null; return; }
    window.currentQuestText = text;
    el.innerText = '📜 ' + text;
