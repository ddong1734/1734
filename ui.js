...
window.GLOBAL_ITEM_DB = {
    ...
    // 💥 검은수염 처치 드롭 전용 (20%)
    'gura_fruit': { name: '흔들흔들열매', desc: '평타 시 파공아 발동 (쿨 10초 · 피해 150 · 1초 기절)', color: '#ecf0f1', rarity: '전설', value: 5000, sellPrice: 2500 },
    // ⛓️ 검은수염 처치 드롭 전용 (20%)
    'yami_fruit': { name: '어둠어둠열매', desc: '평타 시 크로우즈 발동 (쿨 7초 · 흡인 후 2초 속박, 0.5초마다 25)', color: '#34495e', rarity: '전설', value: 5000, sellPrice: 2500 },
