...
window.renderGameFrame = (ctx, myPlayer, players, serverMonster, serverProjectiles, serverShockwaves, serverDetectors, visualFX, serverBases, serverOkras, BLUE_SHOP_X, RED_SHOP_X, BLUE_SMITH_X, RED_SMITH_X, BLUE_NEXUS_X, RED_NEXUS_X, BLUE_STORAGE_X, RED_STORAGE_X, BUSHES, magmas, mantleBolts, serverHinbeom) => {
    const state = {
