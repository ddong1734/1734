...
//  ✅ [수정] 바제스 등장/점프 이펙트 및 빨간 표시 범위를 2배로 확대
// ============================================================================
...
//    ✅ [수정] 기본 반경 2배 확대 (170 → 340) + 지면 투영선 추가
// ============================================================================
registerVisualFX('burgess_telegraph', (ctx, fx, alpha, state) => {
    ...
    // 공중 착지 예고라면 지면까지 이어지는 세로 투영선을 그린다
...
// ============================================================================
// 🌪️ 바제스 착지 풍압 — 큰 충격파
//    ✅ [수정] 기본 반경 2배 확대 (150 → 450) + 방사 갈래 24개로 증가
// ============================================================================
