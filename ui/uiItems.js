...
window.GLOBAL_ITEM_DB = {
    ...
    'world_cleave': { name: '세계를 가르는 참격', desc: '4번 스킬 개방 — 0.5초 경직 후 전방으로 방어 무시 관통 참격 (피해 850 · 쿨타임 130초)', color: '#0a0a0e', rarity: '???', value: 0, sellPrice: 0 },
    // 🌑 신규 ??? 등급 아이템: 유명이경 역월 (마허라 2차 퀘스트 보상 · 다부라 전용)
    'yumyeong': { name: '유명이경 역월', desc: '⬛다부라 전용 · 4번 스킬 개방 — 1초 시전 후 영역 전개 (전개 4초 · 지속 15초 · 쿨타임 180초) · 세계를 가르는 참격과 함께 장착 불가', color: '#0a0a0e', rarity: '???', value: 0, sellPrice: 0 },
    // ✨ 신규 신화 합성 아이템: 새로운 생명
