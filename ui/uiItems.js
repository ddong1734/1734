...
window.GLOBAL_ITEM_DB = {
    ...
    'sukuna_finger': { name: '스쿠나의 손가락', desc: '공격력 +40', color: '#e74c3c', rarity: '전설', value: 12000, sellPrice: 6000 },
    // ⚔️ 다이도 검 계열 (넷은 서로 함께 장착할 수 없다)
    'japgeom': { name: '잡검(雜劍)', desc: '공격력 +10 · ⚔️다이도 스킬 피해 +10%', color: '#3498db', rarity: '일반', value: 800, sellPrice: 400 },
    'dojwama': { name: '도좌마(刀座魔)', desc: '공격력 +30 · 잡검 능력 · ⚔️타격 횟수 증가 (무자비 15→20 · 질풍참 5→7 · 일섬 1→2)', color: '#2ecc71', rarity: '희귀', value: 6000, sellPrice: 3000 },
    'yonggol': { name: '용골(龍骨)', desc: '공격력 +50 · 도좌마의 모든 능력 · ⚔️다이도 모든 스킬에 흡혈 30%', color: '#e74c3c', rarity: '전설', value: 18000, sellPrice: 9000 },
    'seokhondo': { name: '석혼도(石魂刀)', desc: '공격력 +100 · 용골의 모든 능력 · ⚔️방어 무시 · 적중 시 2.5초 동안 상대 회복량 30%로 저하', color: '#9b59b6', rarity: '신화', value: 40000, sellPrice: 20000 },
