...
window.registerNetModule('lobby', function (socket, U) {
    ...
    socket.on('reconnectSuccess', (data) => {
        ...
        // 🔥 저주의 왕
        window.serverCursePortal = data.cursePortal || null;
        window.serverSukuna = data.sukuna || null;
        window.serverSukunaPortal = data.sukunaPortal || null;
        window.serverSukunaFires = data.sukunaFires || [];
