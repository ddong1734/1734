...
// ⚡ 카시모 하지메 전용 상태(전하 · 주력 방출 · 환수호박)를 추가했다.
// 🗣️ [신규] NPC 대화 / 퀘스트 상태를 추가했다.
...
window.serverNpcs = [];               // 🗣️ [신규] NPC 목록
window.serverBases = { 1: { hp: 10000, maxHp: 10000 }, 2: { hp: 10000, maxHp: 10000 } };
window.currentTeamStorage = []; 
window.myNickname = ''; 
window.currentQuestText = null;       // 📜 [신규] 현재 퀘스트 문구
window.npcDialogOpen = false;         // 🗣️ [신규] 대화창 열림 여부
window.currentNearNpcId = null;       // 🗣️ [신규] 근처 NPC id
