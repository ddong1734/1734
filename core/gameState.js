...
//    바닥 발판 { x:22000, y:-4000, w:5000 } + 좌벽 22000 / 우벽 26960 기준
window.DARK_AREA   = { minX: 22000, maxX: 27000, minY: -5200, maxY: -3940 };
window.DARK_GROUND = -4000;
...
window.shakeUntil = 0;
window.shakeMag = 0;
window.triggerScreenShake = (durationMs, magnitude) => {
...
window.myPlayer = { 
    ...
    portalDwellUntil: 0,                                   // 🌀 포탈 대기 카운트다운
