...
//    검은수염 스킬로 인한 흔들림은 '암흑 왕좌 안에 있는 플레이어'에게만 적용된다.
window.shakeUntil = 0;
window.shakeMag = 0;
...
window.serverBurgess = null;          // 🟪 지저스 바제스 (검은수염 체력 절반 이하에서 소환)
...
window.myPlayer = { 
    ...
    darkBanned: false,                                     // 🚫 암흑 왕좌에서 사망 → 재입장 금지
