...
// 🏵️ [신규] 여의 장착 시 주력 방출 좌우 범위 증가
const K_SURGE_YEOUI_WIDTH = 1150;

// ============================================================================
// ⚡🔮 3번 스킬 : 환수호박(幻獸琥珀)
//    · ✅ [수정] 이동속도 1.3배 (기존 1.5배)
//    · 죽을 때까지 해제 불가. 모든 회복 기능 무효. 초당 최대 체력 4% 소모.
//    · 지나간 자리에 2초 지속 전기 잔상.
//    · ✅ [신규] 평타를 누르면 조이스틱 방향으로 순간이동한다.
// ============================================================================
const K_AMBER_COOLDOWN   = 60000;
const K_AMBER_SPEED_MULT = 1.3;     // ✅ 1.5 → 1.3
const K_AMBER_DRAIN_PCT  = 0.04;
const K_AMBER_DRAIN_MS   = 1000;
const K_AMBER_TRAIL_MS   = 2000;
const K_AMBER_TRAIL_GAP  = 70;
const K_AMBER_TRAIL_MAX  = 60;

// ⚡🔮 [신규] 환수호박 평타 = 전격 순간이동(블링크)
//    · 이동 거리 = 지저스 바제스의 '지름' (BG_RADIUS × 2 = 151.2)
//    · 가로벽(발판)은 통과할 수 있지만, 세로벽(solid)은 통과할 수 없다.
//    · 출발지 ↔ 도착지 사이에 전류 잔상이 남는다.
//    · 도착지에 전기 폭발 (150 피해 · 1초 기절)
const K_BLINK_DIST      = BG_RADIUS * 2;   // 151.2
const K_BLINK_COOLDOWN  = 400;             // 평타 쿨타임과 별개인 최소 간격
const K_BLINK_FX_MS     = 380;             // 전류 잔상 지속
const K_BLINK_BLAST_DMG    = 150;
const K_BLINK_BLAST_STUN   = 1000;
const K_BLINK_BLAST_RADIUS = 190;
const K_BLINK_BLAST_FX_MS  = 340;
...
// ⚡🌩️ [신규] 뇌신 장착 시 음파와 함께 번개 7발이 부채꼴로 동시 발사된다
...
module.exports = {
    ...
    K_BLINK_DIST, K_BLINK_COOLDOWN, K_BLINK_FX_MS,
    K_BLINK_BLAST_DMG, K_BLINK_BLAST_STUN, K_BLINK_BLAST_RADIUS, K_BLINK_BLAST_FX_MS,
