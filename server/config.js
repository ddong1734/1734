...
// ============================================================================
// ⚡ 카시모 하지메 — 보랏빛 전기 특성
//    ✅ [수정] 카시모의 모든 스킬은 화면 흔들림을 발생시키지 않는다.
// ============================================================================
...
const K_AMBER_SPEED_MULT = 1.5;     // ✅ 이동속도 배율 (1.7 → 1.5)
