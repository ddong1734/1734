...
const SK_SLASH_TELE_MS  = 1000;   // 1초 전 예고(불투명 빨간 박스)
const SK_SLASH_DMG      = 200;    // 피해 200
const SK_SLASH_W        = 560;    // 참격 범위(가로)
const SK_SLASH_H        = 300;    // 참격 범위(세로)
...
const SK_BOW_BLAST_R   = 420;    // 폭발 반경
const SK_BOW_FIRE_MS   = 4000;   // 불길 지속 4초
const SK_BOW_FIRE_R    = 460;    // 불길 반경
