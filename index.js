...
const CROWS_RANGE      = 1680 * 3;             // ✅ 각성 엘 토르와 동일한 사거리 (range 1680, 각성 시 두께 3배)
const CROWS_THICKNESS  = 90 * 3;               // ✅ 각성 엘 토르 두께 (90 * 3 = 270)
const CROWS_PULL_MS    = 900;                  // 끌려오는 시간 (이 동안 스킬 봉인)
const GURA_DAMAGE      = 500;                  // 파공아 피해량
const GURA_RADIUS_MULT = 1.2;                  // ✅ 검은수염 크기의 1.2배
...
const DESCENT_RISE     = 900;                  // 공중으로 띄어오르는 높이
...
const BB_DELTA_FIELDS = [
    ...
    'castingUntil', 'telegraphUntil', 'darkFloorUntil',
    'frozenUntil', 'electrocutedUntil', 'airFreezeUntil', 'raigoPullUntil',
    'burningUntil', 'maguBombUntil', 'justiceBombUntil'
];
...
const serverContext = {
    ...
    PORTAL_COOLDOWN, PORTAL_DWELL_MS,                                  // 🌀 추가
    ...
    DESCENT_CHANCE, DESCENT_ROLL_MS, DESCENT_DURATION, DESCENT_TICK_MS, DESCENT_TICK_DMG, DESCENT_RISE
};
