...
function recalcStats(p) {
    ...
    // ⬛ ■ 는 어둠어둠 + 번쩍번쩍의 효과를 모두 포함한다
    if (p.hasSquare) { p.hasYami = true; p.hasPika = true; }
...
/** ⬛ 다부라가 지금 '조작 봉인' 상태인가 (빛 시전 / 발차기 응축) */
