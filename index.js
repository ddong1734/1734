...
// 🌲 정글 미러링 기준 폭 (월드 폭이 늘어나도 레드팀 위치가 변하지 않도록 고정)
...
// ============================================================================
// ⚫ 검은수염 (암흑 왕좌 전용 보스)
//    ✅ [수정] 레드팀 정글에서 절대 보이지 않도록 x 36000~41000 으로 멀리 이동
//    바닥 : { x: 36000, y: 2000, w: 5000, dark }
//    좌벽 : { x: 36000, y: -1000, h: 3000, solid, dark }
//    우벽 : { x: 40960, y: -1000, h: 3000, solid, dark }
// ============================================================================
...
// 렌더/스폰 격리 구간 (gameState.js 의 DARK_ZONE_X 와 동일)
const DARK_ZONE_MIN = 35400;
const DARK_ZONE_MAX = 41600;

const BB_RADIUS = HINBEOM_RADIUS;                       // 94.5
const BB_MAXHP  = Math.round(HINBEOM_MAXHP * 1.2);      // 12000 (회복 없음)
const BB_SPEED  = 1.75;
...
const BG_MAXHP       = Math.round(BB_MAXHP * 0.5);       // 6000
const BG_SPEED       = 2.2;
const BG_GOLD        = 4000;
const BG_XP          = 800;
...
// ✅ [수정] 등장 공격 범위 1.5배 (2.0 → 3.0)
const BG_LAND_MULT   = 3.0;
...
// ✅ [수정] 점프 공격 범위 1.5배 (1.5 → 2.25)
const BG_JUMP_MULT      = 2.25;
...
// ✅ [수정] 블루팀 / 레드팀 오크라를 완전히 대칭으로 배치한다.
//    블루팀 : x = 1500, 2100, 2700 ... 5700 (8마리)
//    레드팀 : 기준 폭 32000 을 축으로 미러링 → 30500, 29900 ... 26300 (8마리)
for(let i = 0; i < 8; i++) {
    let bx = 1500 + i * 600;
    spawnOkra(bx, 1955);                       // 블루팀
    spawnOkra(MIRROR_WIDTH - bx, 1955);        // 레드팀 (완전 대칭)
}
