...
const DARKFLOOR_SLOW     = 0.3;   // ✅ 시전 4초 동안 이동속도 0.3배 (클라이언트 physics 에서 적용)
...
// ✅ [수정] 체력 1.2배 추가 증가 (검은수염의 0.5배 = 7200)
 ...
 *    ✅ [수정] 적중 판정을 '보이는 빨간 표시'와 완전히 동일하게 맞춘다.
 *       - 두께 : 표시된 띠 폭 그대로(CROWS_THICKNESS / 2)
 *       - 사거리 : 표시 끝의 원형 마커(반지름 = 두께의 0.9배)까지 포함
 *       - 시전자 바로 뒤쪽에 살짝 걸친 대상도 표시 안이면 포함되도록 여유(-half)
 */
