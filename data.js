...
window.GameData = {
    ...
    Map: {
        ...
        Platforms: [
            ...
            // ⚫ 검은수염 전용 공간 '암흑 왕좌'
            //    ✅ [수정] 상공(-4000) → 지상과 동일한 높이(GROUND_Y = 2000)로 내리고,
            //       기존 맵과 겹치지 않도록 맵 최우측(x 28000~33000)으로 멀리 떨어뜨렸다.
            //       → 유성화산(spawnY -2900) · 만뢰 · 뇌영 등 하늘에서 떨어지는 스킬이 정상적으로 보인다.
            { x: 28000, y: 2000, w: 5000, h: 40,  dark: true },
            { x: 28000, y: 1100, w: 40,   h: 900, solid: true, dark: true },
            { x: 32960, y: 1100, w: 40,   h: 900, solid: true, dark: true }
        ],
        JungleBlueData: [
