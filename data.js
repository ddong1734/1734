...
window.GameData = {
    ...
    Map: {
        ...
        Platforms: [
            ...
            // ⚫ 검은수염 전용 공간 '암흑 왕좌'
            //    지상과 동일한 높이(GROUND_Y = 2000) · 맵 최우측(x 28000~33000)
            //    ✅ [수정] 좌우 벽을 아주 높게(3000) 세워 기존 맵과 완전히 격리한다.
            //       또한 렌더링 단계에서도 이 구간에 들어오면 기존 맵 요소를 그리지 않는다.
            { x: 28000, y: 2000, w: 5000, h: 40,  dark: true },
            { x: 28000, y: -1000, w: 40,  h: 3000, solid: true, dark: true },
            { x: 32960, y: -1000, w: 40,  h: 3000, solid: true, dark: true }
        ],
        JungleBlueData: [
