...
window.GameData = {
    ...
    Map: {
        ...
        Platforms: [
            ...
            // ⚫ 검은수염 전용 공간 '암흑 왕좌' (박힌범 포탈로만 진입 가능 · 지상과 완전히 분리된 상공 섬)
            //    바닥 윗면 y = -4000, 내부 공간 x 22040 ~ 26960
            { x: 22000, y: -4000, w: 5000, h: 40,  dark: true },
            { x: 22000, y: -4900, w: 40,   h: 900, solid: true, dark: true },
            { x: 26960, y: -4900, w: 40,   h: 900, solid: true, dark: true }
        ],
        JungleBlueData: [
