...
window.GameData = {
    ...
    Characters: {
        ...
        KURUSU: {
            hp: 1000, baseDamage: 45, attackCooldown: 500, speedMult: 1.05,
    ...
    Skills: {
        ...
        'DAIDO_S2': {
            ...
            duration: 1500, speedMult: 2.6,
            tickInterval: 200, tickDamage: 27, hitRadius: 190,
            pullRadius: 50,
        ...
        'KURUSU_S3': {
            type: 'kurusu_ladder', cd: 30000,
            castTime: 2000, beamTime: 3000,
            tickInterval: 200, tickDamage: 70, cdPenalty: 1000,
            beamHalfWidth: 190, circleRadius: 420,
            maxTickDamage: 100, maxBeamHalfWidth: 330, maxCircleRadius: 620,
