...
const Items = {
    ...
    // 💎 해루석 (전설) — 해루석 오크라 처치 시 25% 확률 · 암매상 10,000 G
    //    ⚠️ 장착 효과는 없다. 판매하면 10,000 G 를 받는 '재료 · 환금용' 아이템이다.
    'haeru': {
        type: 'attack', buyPrice: 0, sellPrice: 10000,
        displayName: '해루석',
        stats: {}
    },

    // 🔥 스쿠나의 손가락 (전설) — 헤이안 스쿠나 처치 시 50% 확률
    'sukuna_finger': {
    ...
    'yonggol': {
        ...
        recipe: { cost: 0, ingredients: ['dojwama', 'gold', 'gold', 'gold', 'gold', 'gold', 'sukuna_finger', 'haeru'] }
    },
    ...
    'seokhondo': {
        ...
        recipe: { cost: 0, ingredients: ['yonggol', 'gold', 'gold', 'gold', 'gold', 'gold', 'sukuna_finger', 'sukuna_finger', 'sukuna_finger', 'haeru', 'haeru', 'haeru'] }
    },
